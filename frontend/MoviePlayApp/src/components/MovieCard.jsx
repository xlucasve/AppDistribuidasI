    ...
    return (
        <View style={styles.container}>
            <View style={styles.poster.container}>
                <Image source={movie.posterImageLink} alt={movie.title} style={styles.poster.image} />
            </View>

            <View style={styles.body.container}>
                <Text style={styles.body.title}>{movie.title}</Text>
                <View style={styles.body.rating.container}>{ratingStarsList}
                    <Text style={styles.body.rating.text}>{movie.rating}</Text></View>
                <View style={styles.body.genre}>{genresList}</View>
                <Pressable style={styles.body.favorite} onPress={() => setIsFavorite(!isFavorite)}>
                    {!isFavorite
